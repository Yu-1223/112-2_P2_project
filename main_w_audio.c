                ...
                if(array) 
                {
                    ...
                    {                     
                        ...
                        if(userOptions == 4) // open backpack
                        {
                            ...
                            display_interface(backpackImage, "backpack Opened! Press \"b\" again to close or choose to apply item!", userOptions, "Soothing ball", "Sad", "Happy", "Boring");
                            ...
                            {
                                display_interface(backpackImage, "backpack Closed!", userOptions, "Soothing ball", "Sad", "Happy", "Boring");
                        ...
                        if(userOptions == 3 || promptFlag == 1)
                        {
                            ...
                            if(subtable) 
                            {
                                ...
                                if(character && text) 
                                {
                                    ...
                                    display_interface((char *)image + 1, (char *)text, userOptions, "Soothing ball", "Sad", "Happy", "Boring");
                                }
                                ...
                                if(prompt) 
                                {
                                    ...
                                    if(promptQ)
                                    {
                                        ...
                                        if(userOptions == 3)
                                        {
                                            display_interface((char *)image + 1, (char *)promptQ, userOptions, "Soothing ball", "Sad", "Happy", "Boring");
                                        }
                                    }
